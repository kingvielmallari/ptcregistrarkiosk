...
<nav class="navbar navbar-dark bg-primary" style="background: rgb(17,10,134);
  ...
  <a class="btn btn-light btn-sm" href="registrar/index.php" role="button" style="margin-left: auto">Registrar</a>
</nav>
        ...
        <div class="card ">
            ...
            <div class="card-body">
               ...
               <br>
                    ...
                    <div class="form-group">
                        <input class="form-control form-control-lg" id="username" alt="username" type="text" placeholder="Student ID" autocomplete="off">
                    </div>
                    <script>
