...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $printer->text("Control No: $control_no\n");
        $printer->text("Student ID: $studentID_no\n");
        $printer->text("Email Address: $email_address\n");
        $printer->text("Document Name: $document_name\n");
        $printer->text("Number of Copies: $no_ofcopies\n");
        $printer->text("Date Requested: $date_request\n");
        $printer->text("\n");
        $printer->text("---------------------------\n");
        $printer->text("Please Proceed to Cashier for Payment.\n");
        $printer->text("---------------------------\n");
